...
EXPECTED_MODEL_ID = "hexgrad/Kokoro-82M"
...
EXPECTED_OUTPUTS = (
    'outputs/kokoro_tts_result.json',
    'outputs/kokoro_tts_sample.wav',
)
# Profile-specific code the notebook must exercise through the repository public API.
CODE_MARKERS = (
    'from kokoro_tts_pipeline import DEFAULT_LANG_CODE, DEFAULT_VOICE, LANG_CODES, MAX_SPEED, '
    'MAX_TEXT_CHARS, MIN_SPEED, SAMPLE_RATE',
    'from kokoro_tts_pipeline import LOADER_WEIGHTS_ONLY, MODEL_ID, MODEL_KEY, MODEL_REVISION, '
    'WEIGHT_FORMAT, KokoroTTSPipeline, list_voices, stage_missing_files, verify_snapshot',
    ...
    "ceilings = {'MAX_TEXT_CHARS': MAX_TEXT_CHARS, 'MIN_SPEED': MIN_SPEED, 'MAX_SPEED': MAX_SPEED, "
    "'SAMPLE_RATE': SAMPLE_RATE, 'LANG_CODES': LANG_CODES, 'DEFAULT_LANG_CODE': DEFAULT_LANG_CODE, "
...
MARKDOWN_MARKERS = (
    '**Capability:** text-to-speech (24 kHz mono float32 waveform',
    '**No adaptation occurs:**',
    '**Speech quality has no intrinsic metric:**',
    '**The output is not bit-deterministic by default:**',
