...
EXPECTED_OUTPUTS = (
    "outputs/kokoro_tts_input_manifest.json",
    "outputs/kokoro_tts_evaluation_report.json",
...
# `import kokoro` / `import misaki` / `import soundfile` are absent here on purpose: the generated
# install cell imports them to report the pinned runtime identity, and the export stage writes the
# WAV through the pinned `soundfile`, neither of which is model logic.
